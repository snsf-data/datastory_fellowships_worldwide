...
datastory_name <- "fellowships_worldwide"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "where-do-our-postdoc-mobility-grantees-go"
datastory_name_de <- "wohin-gehen-unsere-postdoc-mobility-stipendiatinnen-und-stipendiaten"
datastory_name_fr <- "ou-vont-nos-boursieres-et-boursiers-postdoc-mobility"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "Where do our Postdoc.Mobility grantees go? Europe is the trend" 
lead_en <- "The SNSF sends hundreds of early-career researchers all over the world every year to take part in multi-year international research visits. Where do they go?" 
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Wohin zieht es durch Postdoc.Mobility geförderte Forschende? Europa liegt im Trend" 
lead_de <- "Jedes Jahr fördert der SNF Hunderte von jungen Forschenden, die für einen mehrjährigen Forschungsaufenthalt ins Ausland gehen. Doch wohin zieht es sie?" 
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "Où vont nos boursières et boursiers Postdoc.Mobility ? L'Europe a le vent en poupe"
lead_fr <- "Le FNS envoie chaque année des centaines de chercheuses et de chercheurs en début de carrière dans le monde entier pour participer à des séjours de recherche internationaux." 
# Contact persons, always (first name + last name)
contact_person <- c("Oliver John", "Martina Haug", "Anne Jorstad")
